...
class GetMusicsThread extends Thread {

    private final String tag = "GetMusicsThread.java";
    ...
    public GetMusicsThread(Context context) {
    ...
    private void getMusicList() {
        ...
        if (isSdcardMusic) {
            LogUtil.d(tag, "EXTERNAL, 总共找到" + musicList.size() + "个音乐文件");
            MusicFileHelper.sdcardMusicList = musicList;
        } else {
            LogUtil.d(tag, "INTERNAL, 总共找到" + musicList.size() + "个音乐文件");
